    ...
    <div className="space-y-6 sm:space-y-8">
      ...
      >
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 sm:mb-6 gap-4">
          <div>
            ...
            <p className="text-neutral-400 text-sm mt-1">Monthly revenue and order trends</p>
          </div>
        ...
        <ResponsiveContainer width="100%" height={300}>
          <BarChart data={revenueData}>
            ...
            <Bar dataKey="orders" fill="#737373" radius={[4, 4, 0, 0]} />
          </BarChart>
        </ResponsiveContainer>
      </motion.div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
        ...
        <motion.div
          ...
          className="card"
        >
          <h3 className="text-lg sm:text-xl font-semibold text-white mb-4 sm:mb-6">Traffic Sources</h3>
        ...
        <motion.div
          ...
          className="card"
        >
          <h3 className="text-lg sm:text-xl font-semibold text-white mb-4 sm:mb-6">User Growth</h3>
          <ResponsiveContainer width="100%" height={250}>
            <AreaChart data={userGrowthData}>
              ...
              />
              <Area type="monotone" dataKey="users" stroke="#ffffff" fill="url(#colorUsers)" strokeWidth={2} />
              <defs>
